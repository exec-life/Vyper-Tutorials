# Setup variable only callable within the contract
...
# Enough money was raised, give funds to beneficary
@external
def finalize():
...
# Not enough money was raised! Refund everyone (max 30 at a time to avoid gas limit)
@external
def refund():
